...
main{
	...
	font-size:15px;
	vertical-align:top;
	background-image: url('chat_background.jpeg');
}
main header{
	height:72px;
	text-align:center;
...
<div id="container">
	<main>
		...
		<header>
				...
				<h2 style="font-size:40px">guro guro chat</h2>
...
<div id="message1" class="message1" style="background-color: skyblue">
