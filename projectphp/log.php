    ...
    <h1 style="color:#FFF;font-size:60px;margin-left:40px;">
    	Guro Guro Chat
    </h1>
    <p style="font-size:30px;margin-left:40px;color:white;">
    	Guro Guro Chat is a Very Guro Guro. Let's Get Started ❤️
    </p>
	</div>
